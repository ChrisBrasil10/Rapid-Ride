...
* Author: Chris Brasil
* Description:
* This describes the trafic at a global level considering the speed, concentration and flows without taking into account the individual behavior af vehicles. 
* Speed, concentration and flow are the three components of the LWR model. 
* This models reproduces flow of traffic and congestion in specific conditions
* 
* In this model, a road is divided into sections and arbitrarily give to the middle section a lower speed and critical concentration.
* Tags: transport
*/
